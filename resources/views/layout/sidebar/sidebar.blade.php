                ...
                <ul>
                    <li data-menu-item="modern-welcome" class="{{ request()->routeIs('dashboard.index')  ? 'menu-item menu-item-single mb-2  menu-item-active' : 'menu-item menu-item-single mb-2' }}">
                        <a class="menu-item-link" href="{{ route('dashboard.index') }}">
                            <svg class="menu-item-icon" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <li class="{{ request()->segment(1) === 'link-hospital' ? 'menu-collapse menu-collapse-item-active' : 'menu-collapse' }}">
                        <div class="menu-collapse-item">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" class="menu-item-icon" height="1em" width="1em">
                    ...
                    <li class="{{ request()->segment(1) === 'lab-test-category' ? 'menu-collapse menu-collapse-item-active' : 'menu-collapse' }}">
                        ...
                        <ul style="{{ request()->segment(1) === 'lab-test-category' ? 'display:block' : 'display:none' }}">
                            ...
                            <li data-menu-item="modern-project-list" class="{{ request()->routeIs('lab.test.category.create') ? 'menu-item menu-item-active' : 'menu-item' }}">
                                <a class="h-full w-full flex items-center" href="{{ route('lab.test.category.create') }}">
                    ...
                    <li class="{{ request()->segment(1) === 'appointment' ? 'menu-collapse menu-collapse-item-active' : 'menu-collapse' }}">
                        ...
                        <ul style="{{ request()->segment(1) === 'appointment' ? 'display:block' : 'display:none' }}">
                            <li data-menu-item="modern-project-list" class="{{ request()->routeIs('appointment.offline.list') ? 'menu-item menu-item-active' : 'menu-item' }}">
                                <a class="h-full w-full flex items-center" href="{{ route('appointment.offline.list') }}">
