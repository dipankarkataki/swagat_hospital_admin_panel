@extends('layout.main')
@section('title', 'List of Hospitals')
@section('content')
                        ...
                        <div class="flex items-center gap-4">
                            ...
                            <div>
                                <div class="flex gap-1.5 items-end mb-2">
                                    <h3 class="font-bold leading-none">{{ count($list_of_hospitals) }}</h3>
                ...
                <div class="card card-layout-frame">
                    <div class="card-body">
                        <div class="overflow-x-auto">
                            <table id="hospitalDataTable" class="table-default table-hover">
                                <thead>
                                    <tr>
                                        <th>Sl No.</th>
                                        <th>Name</th>
                                ...
                                <tbody>
                                    @foreach ($list_of_hospitals as $index => $item)
                                        <tr>
                                            <td>{{ $index + 1 }}</td>
                                            <td>
