@extends('layout.main')
@section('title', 'Create Lab Test Package')
@section('content')
    <div class="page-container relative h-full flex flex-auto flex-col px-4 sm:px-6 md:px-8 py-4 sm:py-6">
        <div class="container mx-auto">
            <div class=" mb-4">
                <h3>Create Lab Test Package</h3>
            </div>
            <div class="card card-border">
                <div class="card-body">
                    <form id="createLabTestPackageForm" class="skip-global-submit">
                        <div class="form-container">
                            ...
                            <div class="form-item">
                               <label class="form-label mb-2">Package Name *
                                    <span class="cursor-pointer" data-bs-toggle="tooltip" data-bs-title="Please donot enter the word 'Package' after the package name. For e.g correct Name -> Swagat Fullbody Checkup. Incorrect Name -> Swagat Fullbody Checkup Package">
                                ...
                                <div class="input-group mb-4">
                                    <input class="input" type="text" name="package_name" placeholder="e.g HBsAg - Quantitative (CMIA)" required>
                                </div>
                            </div>
                            <div class="form-item">
                                <label class="form-label mb-2">Description</label>
                                <div>
                                    <textarea class="input input-textarea" name="package_desc" placeholder="Type test description here..." maxlength="200"></textarea>
                            ...
                            <div class="form-item">
                                ...
                                <div class="mb-4">
                                    <input class="input" type="text" name="package_amount" id="test_amount" placeholder="e.g. 999.23" required>
                                    <span class="ml-1 text-xs">Maximum allowed amount in rupees ₹ 9999.99</span>
                                </div>
                            </div>
                            <div class="form-item">
                                <div>
                                    <button class="btn btn-default" type="submit" id="submitLabTestPackageForm">Submit</button>
                                </div>
                            </div>
                        </div>
                    </form>
...
@section('custom-scripts')
    <script>
        $(document).ready(function() {
            ...
            //Create Lab Test
            $('#createLabTestPackageForm').on('submit', function(e){
                e.preventDefault();

                const formData = new FormData(this);

                $('#submitLabTestPackageForm').attr('disabled', true).text('Please wait...');
                ...
                $.ajax({
                    ...
                    success: function(response){
                        if(response.success === true){
                            ...
                            $('#createLabTestPackageForm')[0].reset();
                        }else{
                        ...
                        $('#submitLabTestPackageForm').attr('disabled', false).text('Submit');
                    }
                });
            });
        });
