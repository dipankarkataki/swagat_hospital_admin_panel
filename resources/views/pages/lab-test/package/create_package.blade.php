                    ...
                    <form id="createLabTestPackageForm" class="skip-global-submit">
                        <div class="form-container">
                            <div class="form-item">
                                ...
                                <div class="mb-4">
                                    <input class="input" type="text" name="package_name" id="package_name" placeholder="e.g. Full Body Checkup" required>
                                </div>
                            </div>
                            <div class="form-item">
                            ...
                            <div class="form-item">
                                ...
                                <div>
                                    <textarea class="input input-textarea" name="package_desc" placeholder="Type test description here..." maxlength="200" required></textarea>
                            ...
                            <div class="form-item">
                                ...
                                <div class="mb-4">
                                    <input class="input amount-input" type="text" name="package_amount" id="package_amount" placeholder="e.g. 999.23" readonly required>
                                </div>
                            </div>
                            <div class="form-item">
                                <label class="form-label mb-2">Discount (in %)</label>
                                <div class="mb-4">
                                    <input class="input" type="text" name="package_discount" id="package_discount" placeholder="e.g. 10">
                                </div>
                            </div>
                            <div class="form-item">
        ...
        $(document).ready(function() {
            ...
            $('#createLabTestPackageForm').on('submit', function(e){
                ...
                $.ajax({
                    ...
                    url: "{{route('lab.test.package.create')}}",
                    type: "POST",
                    data: formData,
                    contentType: false,
                    processData: false,
