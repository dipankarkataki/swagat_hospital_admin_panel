@extends('layout.main')
@section('title', 'List of Lab Test')
@section('content')
                        ...
                        <div class="flex items-center gap-4">
                            ...
                            <div>
                                <div class="flex gap-1.5 items-end mb-2">
                                    <h3 class="font-bold leading-none">{{ count($get_all_test) }}</h3>
                                    <p class="font-semibold">Lab Test</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card-body">
                        <div class="overflow-x-auto">
                            <table id="labTestDataTable" class="table-default table-hover">
                                ...
                                <tbody>
                                    @foreach ($get_all_test as $index => $item)
                                        <tr>
                                            <td>{{ $index + 1 }}</td>
                                            <td>
                                            ...
                                            <td>
                                                <div class="flex justify-end text-lg gap-2">
                                                    <a href="{{ route('lab.test.get.by.id', ['id' => encrypt($item->id)]) }}">
                                                    ...
                                                    <a href="{{ route('lab.test.delete', ['id' => encrypt($item->id)]) }}" class="deleteButton">
