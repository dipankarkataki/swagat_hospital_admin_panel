            ...
            <div class="grid border border-gray-950 border-dashed rounded-md p-8 mt-5">
                <div>
                    ...
                    @if ($linked_hospital->status == 1)
                        <button class="btn bg-emerald-500 hover:bg-emerald-400 active:bg-emerald-600 text-white update-account-status" type="button" data-url="{{ route('portfolio.update.linked.hospital.status') }}" data-id="{{ encrypt($linked_hospital->id) }}" data-status=0>
                    ...
                    @else
                        <button class="btn btn-md bg-rose-600 hover:bg-rose-500 active:bg-rose-700 text-white update-account-status" type="button" data-url="{{ route('portfolio.update.linked.hospital.status') }}" data-id="{{ encrypt($linked_hospital->id) }}" data-status=1>
                            <span class="flex items-center justify-center gap-2">
