                    ...
                    <form id="createEventForm" enctype="multipart/form-data" class="skip-global-submit">
                        <div class="form-container">
                            <div class="form-item">
                                ...
                                <div>
                                    <select class="input" name="portfolio_id" id="portfolio_id" required>
                                ...
                                <div class="upload upload-draggable hover:border-primary-600 cursor-pointer h-[300px]">
                                    ...
                                    <div class="text-center">
                                        ...
                                        <div class="flex flex-row justify-center items-center">
                                            <img id="imagePreview" src="" alt="Image Preview" style="display:none; max-width: 400px; max-height:200px; margin-top: 10px; margin-bottom:10px; border-radius: 5px;">
                                        </div>
                                ...
                                <div class="form-item">
                                    ...
                                    <div class="upload upload-draggable hover:border-primary-600 cursor-pointer h-[300px]">
                                        ...
                                        <div class="text-center">
                                            ...
                                            <div class="flex flex-row justify-center items-center">
                                                <img id="thumbnailImagePreview" src="" alt="Image Preview" style="display:none; max-width: 400px; max-height:200px; margin-top: 10px; margin-bottom:10px; border-radius: 5px;">
                                            </div>
                                            <p class="font-semibold">
                                                <span class="text-gray-800 dark:text-white">Drop your image here, or</span>
                                                <span class="text-blue-500">browse</span>
                                ...
                                <div class="form-item">
                                    ...
                                    <div class="upload upload-draggable hover:border-primary-600 cursor-pointer h-[300px]">
                                        ...
                                        <div class="text-center">
                                            ...
                                            <div class="flex flex-row justify-center items-center">
                                                <video id="videoPreview" src="" alt="Video Preview" style="display:none; max-width: 400px; max-height:200px; margin-top: 10px; margin-bottom:10px; border-radius: 5px;" controls></video>
                                            </div>
                                            <p class="font-semibold">
